    ...
    return (
        <div className="relative min-h-screen bg-brand-dark-bg-secondary p-6 flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 mt-16">
                <a href="https://www.instagram.com/verituscap?igsh=MTZpdWQ1bXZ0ZnNtaw" target="_blank" rel="noopener noreferrer">
                    <svg
                        className="w-6 h-6 text-brand-brown hover:text-brand-text-light/60 transition-colors"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                    >
